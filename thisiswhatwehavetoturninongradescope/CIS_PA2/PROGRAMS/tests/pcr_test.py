...
if __name__ == "__main__":
    ...
    perfect_expected, perfect_measured = find_expected_calibration_object("./data/pa2-debug-a-calbody.txt", "./data/pa2-debug-a-calreadings.txt")
    ...
    distorted_expected, distorted_measured = find_expected_calibration_object("./data/pa2-debug-c-calbody.txt", "./data/pa2-debug-c-calreadings.txt")
