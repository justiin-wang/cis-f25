...
for letter in datasets:
    ...
    output_path1 = f"./OUTPUT_graph/pa2-{prefix}-{letter}-output1.txt"
    output_path2 = f"./OUTPUT_graph/pa2-{prefix}-{letter}-output2.txt"
    ...
    plt.savefig(f"./OUTPUT_graph/pa2-{prefix}-{letter}-before.png", dpi=150, bbox_inches='tight')
    plt.close(fig1)
    ...
    plt.savefig(f"./OUTPUT_graph/pa2-{prefix}-{letter}-after.png", dpi=150, bbox_inches='tight')
    plt.close(fig2)
    ...
    plt.savefig(f"./OUTPUT_graph/pa2-{prefix}-{letter}-comparison.png", dpi=150, bbox_inches='tight')
    plt.close(fig3)
